...
function Pencil(ctx, drawing, canvas) {
	...
	this.onInteractionUpdate = function (dnd) {
		if (this.currEditingMode === editingMode.rect) {
			this.currentShape = new Rectangle(dnd.posInitX, dnd.posInitY, dnd.posFinalX - dnd.posInitX, dnd.posFinalY - dnd.posInitY, this.currColour, this.currLineWidth);
			...
			this.currentShape = new Line(dnd.posInitX, dnd.posInitY, this.currColour, this.currLineWidth, dnd.posFinalX, dnd.posFinalY);
		}
		drawing.paint(ctx);
	...
	this.onInteractionEnd = function (dnd) {
		...
		drawing.formes.set(uuid, this.currentShape);
		drawing.paint(ctx);
		updateFormes(uuid, this.currentShape)
